...
use AdminBundle\Entity\Guarantee;
...
class GuaranteeController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        return $this->render('AdminBundle:Guarantee:index.html.twig', array(
            'abouts' => $abouts,
        ));
    }
     ...
     *
     */
    public function editAction(Request $request, Guarantee $about)
    {

        
        //$deleteForm = $this->createDeleteForm($about);
        $editForm = $this->createForm('AdminBundle\Form\GuaranteeType', $about);
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('guarantee_index');
                        
            
        }

        return $this->render('AdminBundle:Guarantee:edit.html.twig', array(
            'about' => $about,
