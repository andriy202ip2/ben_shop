...
use AdminBundle\Entity\Partnertxt;
 ...
 *
 */
class PartnertxtController extends Controller
{
    /**
    ...
    public function indexAction(Request $request)
    {
        ...
        $abouts = $em->getRepository('AdminBundle:Partnertxt')->findOneBy([]);

        return $this->render('AdminBundle:Partnertxt:index.html.twig', array(
            'abouts' => $abouts,
        ));
    }
     ...
     *
     */
    public function editAction(Request $request, Partnertxt $about)
    {

        
        //$deleteForm = $this->createDeleteForm($about);
        $editForm = $this->createForm('AdminBundle\Form\PartnertxtType', $about);
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('partnertxt_index');
                        
            
        }

        return $this->render('AdminBundle:Partnertxt:edit.html.twig', array(
            'about' => $about,
